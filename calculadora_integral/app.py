...
def resolver():
    ...
    try:
        ...
        try:
            ...
            if n <= 0:
                raise ValueError(
                    "El número de subdivisiones 'n' debe ser positivo.")
        except ValueError:
            raise ValueError(
                "El número de subdivisiones 'n' debe ser un entero válido.")
        ...
        try:
            ...
            raise ValueError(
                "Los límites de integración deben ser números válidos.")
